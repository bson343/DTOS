...
jmp 0x07C0:START                                        ; CS 세그먼트 레지스터에 0x07C0을 복사하면서, START 레이블로 이동
                                                        ; BIOS가 디스크 첫 섹터의 부트로더를 인식하고 메모리에 적재,
                                                        ; 적재 후 0x07C0 주소의 명령을 실행.

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;   MINT64 OS에 관련된 환경 설정 값
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
TOTALSECTORCOUNT:   dw  0x01    ; 부트 로더를 제외한 MINT64 OS 이미지의 크기
...
RESETDISK:                          ; 디스크를 리셋하는 코드의 시작
    ...
    int 0x13     
    ; 에러가 발생하면 에러 처리로 이동
    jc  HANDLEDISKERROR             ; jc : 캐리 플래그가 1이면 분기
                                    ; 인터럽트 결과가 에러이면 AH레지스터에 오류코드를 flags의 CF(CarryFlag)를 1로 설정한다.
...
READEND:
    ...
    ; 로딩한 가상 OS 이미지 실행    
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    jmp 0x1000:0x0000               ; 만약 메모리에 적재한 주소가 0x10000인데 왜 해당 명령은 0x1000인가에 대해 의문이 든다면,
                                    ; 리얼 모드 물리주소 계산법을 다시 복습해야 한다.
